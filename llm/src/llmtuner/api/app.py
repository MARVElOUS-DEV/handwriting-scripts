...
from .protocol import (
    ...
    ChatCompletionStreamFinishResponse,
    Finish,
    Function,
    FunctionCall,
    ModelCard,
...
def create_app(chat_model: "ChatModel") -> "FastAPI":
    ...
    async def stream_chat_completion(
        ...
        token_ids = chat_model.engine.tokenizer.encode(response_text, add_special_tokens=False)
        ...
        chunk = ChatCompletionStreamFinishResponse(model=request.model, choices=[choice_data], usage=usage)
        yield jsonify(chunk)
        yield "[DONE]"
